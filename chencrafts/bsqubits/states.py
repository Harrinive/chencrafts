...
# ##############################################################################
def state_sets(h_space, subsys, n_bar, return_1darray=True):
    ...
    if basis_num_0 < sys_dim:
        print(f"Dressed \'coherent\' states with anc 0 are generated by fewer ({basis_num_0}) basis.")
    ...
    if basis_num_1 < sys_dim:
        print(f"Dressed \'coherent\' states with anc 1 are generated by fewer ({basis_num_1}) basis.")

    alpha0 = np.sqrt(n_bar)
    ...
    # even init states
    coef_alpha = coherent_coef_list(basis_num_0, alpha0)
    coef_m_alpha = coherent_coef_list(basis_num_0, -alpha0)
    coef_i_alpha = coherent_coef_list(basis_num_0, 1j * alpha0)
    coef_mi_alpha = coherent_coef_list(basis_num_0, -1j * alpha0)

    d_coef_alpha = d_coherent_coef_list(basis_num_0, alpha0)
    d_coef_m_alpha = d_coherent_coef_list(basis_num_0, -alpha0)
    d_coef_i_alpha = d_coherent_coef_list(basis_num_0, 1j * alpha0)
    d_coef_mi_alpha = d_coherent_coef_list(basis_num_0, -1j * alpha0)

    coef_alpha_anc_1 = coherent_coef_list(basis_num_1, alpha0)
    coef_m_alpha_anc_1 = coherent_coef_list(basis_num_1, -alpha0)
    coef_i_alpha_anc_1 = coherent_coef_list(basis_num_1, 1j * alpha0)
    coef_mi_alpha_anc_1 = coherent_coef_list(basis_num_1, -1j * alpha0)

    d_coef_alpha_anc_1 = d_coherent_coef_list(basis_num_1, alpha0)
    d_coef_m_alpha_anc_1 = d_coherent_coef_list(basis_num_1, -alpha0)
    d_coef_i_alpha_anc_1 = d_coherent_coef_list(basis_num_1, 1j * alpha0)
    d_coef_mi_alpha_anc_1 = d_coherent_coef_list(basis_num_1, -1j * alpha0)
